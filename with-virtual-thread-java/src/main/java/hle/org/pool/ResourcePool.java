 ...
 * </ul>
 * 
 * <p>With virtual threads, resource pooling remains valuable for:
 * <ul>
 *   <li>Expensive resources like CORBA/RMI connections</li>
 *   <li>Downstream services with connection limits</li>
 *   <li>Improved performance through connection reuse</li>
 * </ul>
 * 
 * <p>Example usage:
 * <pre>{@code
